...
public class NativeIO {
	public static class POSIX {
		...
		static final String WORKAROUND_NON_THREADSAFE_CALLS_KEY = "hdfs.workaround.non.threadsafe.getpwuid";
...
//	 * @param Fthe
	...
	private synchronized static void ensureInitialized() {
		if (!initialized) {
			cacheTimeout = new Configuration().getLong("hdfs.security.uid.cache.secs", 4 * 60 * 60) * 1000;
	 ...
	 * hdfs-hdfs with pre/post copy checks.
	 *
	 * @param src
	 *            The source path
	 * @param dst
