...
<head>
    ...
    <link href="/resource/assets/js/colorPicker/bootstrap-colorpicker.css" rel="stylesheet">
    <link href="/resource/assets/js/validate/validate.css" rel="stylesheet">
    <link href="/resource/assets/js/idealform/css/jquery.idealforms.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/resource/assets/js/datepicker/bootstrap-datetimepicker.css">
                    ...
                    <div class="nest" id="Blank_PageClose">
                        ...
                        <div class="body-nest" id="Blank_Page_Content">
                            ...
                            <div class="form-group">
                                <div class="col-lg-2">
                                    <label class="form-label">选择数据项</label>
                                </div>
                                <select id="dataConfigure" class="col-lg-3">
                                    <script>
                                        var select = document.getElementById("dataConfigure");
                                        var dataItemList = JSON.parse('${requestScope.get('dataItemList')}');
                                        for (var dataItemId in dataItemList){
                                            var option = document.createElement("option");
                                            option.id = dataItemId;
                                            option.innerText = dataItemList[dataItemId];
                            ...
                            <div id="time2" class="form-group" style="display: none;">
                                <div class="col-lg-2">
                                    <label class="form-label">爬取时间</label>
                                </div>
                                <div id="datetimepicker1" class="input-group date col-lg-3">
                            ...
                            <div class="form-group">
                                <div class="col-lg-4">
                                    <button onclick="addSpiderSet()" type="button" class="btn btn-success" style="margin-left:10px;">
...
<%--<script src="/resource/assets/js/set_clock.js"></script>--%>
...
<script>
    function addSpiderSet() {
        var dataItemSelect = document.getElementById("dataConfigure");
        var dateItemName = dataItemSelect.options[dataItemSelect.selectedIndex].innerText;
        var typeSelect = document.getElementById("set");
        var typeName = typeSelect.options[typeSelect.selectedIndex].innerText;
//        var time = document.getElementById("time").getElementsByTagName("input")[0].value;

        var time = "";
        var time1 = document.getElementById("time1");
        var time2 = document.getElementById("time2");
        if (time1.style.display == "none"){
            time = time2.getElementsByTagName("input")[0].value;
        }else if (time2.style.display == "none"){
            time = time1.getElementsByTagName("input")[0].value;
        }
        ...
        $.ajax({
            type: "post",
            url: "/dataManage/setSpider",
            async: false,
            data: {dateItemName: dateItemName, typeName: typeName, time: time},
            dataType: "text",
            success:function () {
                alert("修改成功");
            },
