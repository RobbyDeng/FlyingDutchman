            ...
            <div class="row">
                ...
                <div class="tab-pane fade in active" id="query">
                    ...
                    <div class="col-lg-2">
                        <div class="row">
                            <div style="height: 20px;"></div>
                            <button onclick="queryLine()" type="button" class="btn btn-success">查询</button>
                        </div>
                    </div>
                    <div style="height: 120px"></div>
                    <br>
                    <br>
                    <table id="lineList" class="table-striped footable-res footable metro-blue" data-page-size="10">
                        <%--加载表头--%>
                        <script>
                            var table = document.getElementById("lineList");
