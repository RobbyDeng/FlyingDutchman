                ...
                <div class="col-sm-12">
                    ...
                    <div class="nest" id="Blank_PageClose">
                        ...
                        <div class="body-nest" id="Blank_Page_Content">
                            <div class="form-inline">
                                <form role="form" class="form-inline">
                                    <div class="form-group col-lg-4">
                                        <label>航班号</label>
                                        <br>
                                        <input id="flightCode" type="text" class="form-control">
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label>出发日期</label>
                                        <br>
                                        <input type="text" class="form-control" id="dp1" value="03-7-2019">
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="row">
                                            <div style="height: 23px"></div>
                                            <button onclick="queryFlight()" type="button" class="btn btn-success">查询</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <table id="flightList" class="table-striped footable-res footable metro-blue" data-page-size="6">
                                <%--加载表头--%>
                                <script>
...
<script>
    ...
    function queryFlight() {
        var flightCode = document.getElementById("flightCode").value;
        ...
        $.ajax({
            type: "post",
            url: "/flightSearch/queryFlight",
            async: false,
            data: {flightCode: flightCode, date: date},
            dataType: "json",
