                            ...
                            <div class="content-wrap">
                                <div class="row">
                                    ...
                                    <ul id="myTab" class="nav nav-tabs">
                                        <li class="active">
                                            <a href="#province" data-toggle="tab">
                                                图表视图
                                            </a>
                                        </li>
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        ...
                                        <!--机型统计tab-->
                                        <div class="tab-pane fade in active" id="province">
                                            <div class="content-wrap">
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            <div id="RealTimeClose" class="nest">
                                                                <div class="title-alt">
                                                                    <h6>
                                                                        <span class="fontawesome-resize-horizontal"></span>&nbsp;机场数量分布图</h6>
                                                                    <div class="titleClose">
                                                                ...
                                                                <div id="RealTime" class="body-nest">
                                                                    <div id="pie" style="height: 300px;width: 300px;"></div>
                                                                    <script type="text/javascript">
                                                                        $.getJSON('/resource/assets/json/airportStatistics.json',function(area){
                                                                            var data = [];
                                        ...
                                        <div class="tab-pane fade" id="data">
                                            ...
                                            <div class="body-nest" id="Filtering">
                                                ...
                                                <div class="row" style="margin-bottom:10px;">
                                                    <div class="col-sm-4">
                                                        <input class="form-control" id="filter" placeholder="省份搜索" type="text" >
                                                    </div>
                                                </div>
...
<script>
    ...
    $.getJSON('/resource/assets/json/airportStatistics.json',function(area){
        ...
        for (var key in area){
            ...
            tdCity.innerText = key;

            var tdNumber = document.createElement("td");
            tdNumber.innerText = list.length;

            var tdAirport = document.createElement("td");
            var ul = document.createElement("ul");
            for (var i in list){
                var li = document.createElement("li");
                li.innerText = list[i];
